export default {
  ...
  home: {
    ...
    autopilotHealth: "Здоровье: {{percent}}%",
  },
  zapret: {
    title: "Zapret",
  ...
  autopilot: {
    title: "Автопилот",
    description:
      "Фоновые проверки Discord, YouTube и других целей. При падении качества EasyZapret может переключать стратегии и при необходимости включать WARP или Telegram Proxy.",
    enabled: "Включить автопилот",
    enabledDesc: "Проверки по расписанию, пока приложение открыто.",
    health: "Здоровье",
    ...
    switchModeDesc: "Как автопилот выбирает следующую стратегию при низком здоровье.",
    switchModes: {
    ...
    bestByTestsNote:
      "Режим «Лучшая по тестам» кратковременно запускает каждую кандидатную стратегию — возможен короткий перерыв в работе.",
    policies: {
      stability: "Стабильность",
      speed: "Скорость",
      gaming: "Игры",
    },
    minHealth: "Минимальное здоровье",
    minHealthDesc: "Реагировать, когда успешных проб меньше этого порога.",
    autoSwitch: "Авто-смена стратегии",
    autoSwitchDesc: "Переключать на следующую стратегию из списка политики при низком здоровье.",
    ...
    autoWarpDesc: "Включать WARP при деградации (нужен Zapret).",
    autoTg: "Авто-включение Telegram Proxy",
    autoTgDesc: "Запускать tg-ws-proxy при деградации.",
    notifySwitch: "Уведомлять о смене стратегии",
    notifyDegraded: "Уведомлять о падении здоровья",
    serviceNote:
    ...
    toastDegraded: "Автопилот: здоровье упало до {{percent}}%",
  },
  whatsNew: {
    ...
    gotIt: "Понятно",
    itemAutopilot:
      "Режимы автопилота — ротация по политике, только ваш список стратегий или выбор лучшей по быстрым тестам.",
    itemUpdater:
      "Обновления внутри приложения — установка новой версии EasyZapret из настроек или окна обновления (подписанные релизы GitHub).",
    itemZapret:
